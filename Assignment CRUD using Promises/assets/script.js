...
function showLoginForm() {
    ...
    submitButton.addEventListener("click", handleLoginBtn);
    function handleLoginBtn() {
        handleLogin();
        submitButton.removeEventListener("click", handleLoginBtn);
    }
...
function handleLogin() {
    ...
    getLocalStorage('jsonData').then(jsonData => {
...
//         setLocalStorage('jsonData', jsonData);
//     })
...
function get_json_data() {
    ...
    if (jsonDataString && sessionData) {
        ...
        jsonData.forEach((item, index) => {
            ...
            //order
            const columns = ['SR', 'UID', 'EMAIL', 'AGE'];
...
function deleteUser(userId) {
    ...
    setLocalStorage('delData', delData);
